...
<g clip-path="url(#clip0_17086_868)">
...
<rect width="56" height="56" fill="white"/>
    ...
    icon: (
      <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#clip0_17086_613)">
...
<rect width="56" height="56" fill="white"/>
    ...
    icon: (
      <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#clip0_17086_629)">
...
<rect width="56" height="56" fill="white"/>
    ...
    icon: (
      <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#clip0_17086_644)">
...
<rect width="56" height="56" fill="white"/>
    ...
    icon: (
      <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#clip0_17086_809)">
...
const Categories = () => {
  return (
    <div className="mb-[70px] flex gap-[30px]">
      {categories.map((category) => (
      <div
      key={category.id}
        className="w-[170px] h-[145px] flex items-center justify-center flex-col opacity-100 border rounded border-[#BDBDBD]
      cursor-pointer hover:bg-[#DB4444] transition-all duration-300 hover:text-white"
      >
        {category.icon}
        <p className="mt-4 font-normal text-base leading-6 tracking-[0%] font-poppins">{category.title}</p>
      </div>
      ))}
    </div>
  );
