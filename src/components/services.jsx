...
const services = [
  {
    ...
    icon: (
      ...
      >
        ...
        <g clip-path="url(#clip0_17170_331)">
          <path
...

  {
    ...
    icon: (
      ...
      >
        ...
        <g clip-path="url(#clip0_17170_348)">
          <path
    ...
    desk: "Friendly 24/7 customer support",
  },
      ...
      {services.map((service) => (
        ...
        key={service.id}
         className="flex flex-col items-center justify-between w-[262px] h-[181px]  mb-[140px]">
          ...
          <p className="font-normal text-sm leading-[21px] tracking-[0%]  font-poppins mt-2">
            {service.desk}
          </p>
        </div>
      ))}
